...
export default function MfaVerify() {
  ...
  const { loginId, email, risk, devOtpCode } = location.state || {};
  ...
  return (
    <div className="page auth-page">
      <div className="auth-card">
        <h2>Extra verification needed</h2>
        <p className="auth-subtitle">
          This login for {email || 'your account'} looked unusual{' '}
          {risk && <RiskBadge level={risk.level} />}, so we sent a one-time code to your email.
        </p>
