...
Big_company data1 .csv. Imports the existing module without modifying it.
"""
import csv
import sys
...
from external_validation_complete import (
    ...
    OUTPUT_DIR,
    _http_json,
    map_big_company_login,
    map_big_company_session,
    process_dataset,
)
...
# 2. Run big_company only
records, counters = process_dataset(
    "big_company",
    DATASETS["big_company"],
...
out_path = OUTPUT_DIR / "big_company_validation_results.csv"
